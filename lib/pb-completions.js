...
export const config = {
    headerpaths: {
        title: 'Header Paths',
        type: 'string',
        default: "{{{HOME}}}/Library/Application Support/Pebble SDK/SDKs/" +
            ...
            "{{{HOME}}}/Library/Application Support/Pebble SDK/SDKs/" +
            "current/sdk-core/pebble/aplite/include/gcolor_definitions.h",
...
//               atom.config.get('pb-completions.ignoreditems'));
atom.config.onDidChange(reinitProvider);
