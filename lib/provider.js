    ...
    reloadSuggestions(fn, data) {
        ...
        module.exports.processData(fn, suggestions, data, {
            ...
            callback: function(result) {
                ...
                let out = {
                    ...
                    'displayText': result[1] + '', // those are nbsp's!
                    'leftLabel': '#define',
                ...
                if (colorData == 'clear') {
                    ...
                    let args = module.exports.listify(result[2]);
                    if (args.length !== 0) {
                        out.description = `Takes ${args.length} argument` +
                                          `${args.length == 1 ? 's' : ''}.`;
                    }
                }
                return out;
        ...
        module.exports.processData(fn, suggestions, data, {
            ...
            callback: function(result) {
                ...
                let args = module.exports.listify(result[3]);
