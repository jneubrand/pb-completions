...
/*
        ...
        >>>>>>
        >>>>>>>>>>
 >>>>>> >>>>>>>>>>>>>>      Dear future, non-sleep-deprived self:
 >>>>>> >>>>>>>>>>>>>>      -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-
        >>>>>>>>>>
        >>>>>>

~/Library/Application\ Support/Pebble\ SDK/SDKs/current/sdk-core/pebble/aplite/include/pebble.h

https://github.com/jbrooksuk/Sublime-Pebble/blob/master/generate_completions.py

Do it.


What:0 actual support for enums
...
var headerLocations = [
    "{{{HOME}}}/Library/Application Support/Pebble SDK/SDKs/current/sdk-core/pebble/aplite/include/pebble.h",
    "{{{HOME}}}/Library/Application Support/Pebble SDK/SDKs/current/sdk-core/pebble/aplite/include/pebble_worker.h",
    "{{{HOME}}}/Library/Application Support/Pebble SDK/SDKs/current/sdk-core/pebble/aplite/include/pebble_fonts.h"
];

for (let i in headerLocations) {
    headerLocations[i] = headerLocations[i].replace(/\{\{\{HOME\}\}\}/, os.homedir())
}
